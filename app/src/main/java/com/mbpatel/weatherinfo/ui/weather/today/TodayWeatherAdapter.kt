...
import com.mbpatel.weatherinfo.databinding.RowTodayListBinding
...
/**
 * Adapter for the [RecyclerView] in [TodayWeatherFragment].
 */
class TodayWeatherAdapter(private val viewModel: WeatherInfoViewModel) :
    ListAdapter<ForecastData, TodayWeatherAdapter.ForecastViewHolder>(WeatherDiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ForecastViewHolder {
        return ForecastViewHolder(
            DataBindingUtil.inflate(
                LayoutInflater.from(parent.context),
                R.layout.row_today_list, parent, false
            )
        )
    }
    ...
    class ForecastViewHolder(private val binding: RowTodayListBinding) :
