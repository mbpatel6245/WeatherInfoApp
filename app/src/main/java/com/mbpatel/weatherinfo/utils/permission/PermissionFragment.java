...
public class PermissionFragment extends Fragment {
    ...
    public PermissionFragment() {
        Log.d("called","PermissionFragment");
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == REQUEST_CODE && permissions.length > 0 && this.listener != null) {
            final PermissionListener permissionListener = this.listener;
            ...
            permissionListener.onRequestPermissionsResult(acceptedPermissions, refusedPermissions, askAgainPermissions);
